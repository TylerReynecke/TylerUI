...
`);
  ...
  const [gridData, setGridData] = useState([
    ...
    { id: '5', name: 'Clark Kent', email: 'clark@dailyplanet.com', properties: 3, status: 'Active' },
    { id: '6', name: 'Diana Prince', email: 'diana@themyscira.gov', properties: 18, status: 'Active' },
    { id: '7', name: 'Barry Allen', email: 'barry@ccpd.gov', properties: 2, status: 'Active' },
    { id: '8', name: 'Hal Jordan', email: 'hal@ferrisair.com', properties: 8, status: 'Inactive' },
    { id: '9', name: 'Arthur Curry', email: 'arthur@atlantis.org', properties: 35, status: 'Active' },
    { id: '10', name: 'Oliver Queen', email: 'oliver@queenindustries.com', properties: 29, status: 'Active' },
    { id: '11', name: 'Peter Parker', email: 'peter@dailybugle.com', properties: 1, status: 'Active' },
    { id: '12', name: 'Tony Stark', email: 'tony@starkindustries.com', properties: 92, status: 'Active' },
    { id: '13', name: 'Steve Rogers', email: 'steve@ssr.mil', properties: 4, status: 'Active' },
    { id: '14', name: 'Bruce Banner', email: 'bruce@culver.edu', properties: 2, status: 'Inactive' },
    { id: '15', name: 'Natasha Romanoff', email: 'natasha@shield.gov', properties: 12, status: 'Active' },
    { id: '16', name: 'Clint Barton', email: 'clint@shield.gov', properties: 7, status: 'Active' },
    { id: '17', name: 'Wanda Maximoff', email: 'wanda@westview.org', properties: 5, status: 'Inactive' },
    { id: '18', name: 'Vision', email: 'vision@avengers.org', properties: 9, status: 'Active' },
    { id: '19', name: 'Sam Wilson', email: 'sam@usaf.mil', properties: 3, status: 'Active' },
    { id: '20', name: 'Bucky Barnes', email: 'bucky@howlingcommandos.com', properties: 2, status: 'Active' },
    { id: '21', name: 'Loki Laufeyson', email: 'loki@asgard.gov', properties: 15, status: 'Inactive' },
    { id: '22', name: 'Thor Odinson', email: 'thor@asgard.gov', properties: 28, status: 'Active' },
    { id: '23', name: 'Stephen Strange', email: 'stephen@kamartaj.org', properties: 6, status: 'Active' },
    { id: '24', name: 'Peter Quill', email: 'peter@milano.space', properties: 11, status: 'Active' },
    { id: '25', name: 'Gamora', email: 'gamora@guardians.org', properties: 8, status: 'Active' },
    { id: '26', name: 'Drax the Destroyer', email: 'drax@guardians.org', properties: 4, status: 'Active' },
    { id: '27', name: 'Rocket Raccoon', email: 'rocket@guardians.org', properties: 19, status: 'Active' },
    { id: '28', name: 'Groot', email: 'groot@guardians.org', properties: 33, status: 'Active' },
    { id: '29', name: 'Carol Danvers', email: 'carol@usaf.mil', properties: 21, status: 'Active' },
    { id: '30', name: 'Nick Fury', email: 'nick@shield.gov', properties: 40, status: 'Active' },
    { id: '31', name: 'Maria Hill', email: 'maria@shield.gov', properties: 10, status: 'Active' },
    { id: '32', name: 'Phil Coulson', email: 'phil@shield.gov', properties: 5, status: 'Active' },
    { id: '33', name: 'Matt Murdock', email: 'matt@nelsonmurdock.com', properties: 3, status: 'Active' },
    { id: '34', name: 'Foggy Nelson', email: 'foggy@nelsonmurdock.com', properties: 4, status: 'Active' },
    { id: '35', name: 'Karen Page', email: 'karen@bulletin.com', properties: 2, status: 'Active' },
    { id: '36', name: 'Frank Castle', email: 'frank@punisher.com', properties: 1, status: 'Inactive' },
    { id: '37', name: 'Jessica Jones', email: 'jessica@aliasinvestigations.com', properties: 4, status: 'Active' },
    { id: '38', name: 'Luke Cage', email: 'luke@harlem.org', properties: 7, status: 'Active' },
    { id: '39', name: 'Danny Rand', email: 'danny@randenterprises.com', properties: 61, status: 'Active' },
    { id: '40', name: 'Colleen Wing', email: 'colleen@dojo.org', properties: 5, status: 'Active' },
    { id: '41', name: 'Wade Wilson', email: 'wade@deadpool.com', properties: 2, status: 'Inactive' },
    { id: '42', name: 'Logan Howlett', email: 'logan@xavieracademy.edu', properties: 6, status: 'Active' },
    { id: '43', name: 'Charles Xavier', email: 'charles@xavieracademy.edu', properties: 88, status: 'Active' },
    { id: '44', name: 'Scott Summers', email: 'scott@xavieracademy.edu', properties: 11, status: 'Active' },
    { id: '45', name: 'Jean Grey', email: 'jean@xavieracademy.edu', properties: 9, status: 'Active' },
    { id: '46', name: 'Orono Munroe', email: 'orono@xavieracademy.edu', properties: 14, status: 'Active' },
    { id: '47', name: 'Hank McCoy', email: 'hank@xavieracademy.edu', properties: 17, status: 'Active' },
    { id: '48', name: 'Bobby Drake', email: 'bobby@xavieracademy.edu', properties: 8, status: 'Active' },
    { id: '49', name: 'Rogue', email: 'rogue@xavieracademy.edu', properties: 4, status: 'Active' },
    { id: '50', name: 'Remy LeBeau', email: 'remy@thievesguild.org', properties: 13, status: 'Inactive' }
  ]);
